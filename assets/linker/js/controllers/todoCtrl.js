...
angular.module('app').controller('TodoCtrl', function TodoCtrl($scope, $http, $modal, sailsSocket, $log, filterFilter) {
  $scope.todos = [];
...
/*
  $http.get('/todo?sort=_id%20DESC').then(function(response) {
